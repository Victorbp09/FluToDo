...
namespace FluToDo.App.Controls
{
    //Special thanks to MIKOLAJ KIERES. Adapted from (https://progrunning.net/creating-custom-xamarin-forms-loading-indicator-with-animations/)
